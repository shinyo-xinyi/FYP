...
def test_model(feat_model_path, loss_model_path, part, add_loss, device):
    ...
    test_set = ASVspoof2019("LA", "features/ASVspoof2019/LA/Features_Python/",
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model_dir', type=str, help="path to the trained model", default="./models_retrained/ocsoftmax")
